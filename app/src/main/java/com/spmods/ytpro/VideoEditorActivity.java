...
public class VideoEditorActivity extends Activity {
    ...
    private void buildTopBar() {
        ...
        // Back button
        ImageButton backBtn = makeIconButton("←", dp(36), dp(36));
        ...
        // Undo
        ImageButton undoBtn = makeIconButton("↩", dp(36), dp(36));
        undoBtn.setOnClickListener(v -> showToast("Undo"));
        topBar.addView(undoBtn);

        // Redo
        ImageButton redoBtn = makeIconButton("↪", dp(36), dp(36));
    ...
    private ImageButton makeIconButton(String text, int w, int h) {
        ...
        // Since we can't use ImageButton for text, use TextView instead
        return btn;
    }
