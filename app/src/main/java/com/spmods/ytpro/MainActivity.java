  ...
  private void setupCustomHeader() {
    ...
    searchInput.setOnEditorActionListener((v, actionId, event) -> {
        if (actionId == EditorInfo.IME_ACTION_SEARCH) {
            ...
            if (!query.isEmpty()) {
                userNavigated = true;
                web.loadUrl("https://youtube.com/results?search_query=" + 
...
// ✅ Settings - Open YTPRO settings
  ...
  private void setupBottomNavigation() {
    ...
    navShorts.setOnClickListener(v -> {
        ...
        web.loadUrl("https://youtube.com/shorts");
    });
    ...
    navSubscriptions.setOnClickListener(v -> {
        ...
        web.loadUrl("https://youtube.com/feed/subscriptions");
    });
    ...
    navYou.setOnClickListener(v -> {
        ...
        web.loadUrl("https://youtube.com/feed/account");
    });
  }
