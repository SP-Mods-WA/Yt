  ...
  public void load(boolean dl) {
    ...
    if (Intent.ACTION_VIEW.equals(action) && data != null) {
      ...
      if (sharedText != null && (sharedText.contains("youtube.com") || sharedText.contains("youtu.be"))) {
        url = sharedText;
        userNavigated = true;
        // ✅ FIXED: Enhanced YouTube Styles with proper video positioning and controls
        web.evaluateJavascript(
            "(function() {" +
            "  var style = document.createElement('style');" +
            "  style.id = 'ytpro-enhanced-styles';" +
            "  style.textContent = '" +
            "    /* ✅ CRITICAL FIX: Video positioning */" +
            ...
            "    }" +
            "    " +
            "    /* ✅ CRITICAL FIX: Show ALL controls */" +
            "    .player-controls-top, " +
            ...
            "    }" +
            "    " +
            "    /* ✅ CRITICAL FIX: Show time display */" +
            "    .ytp-time-display, " +
            "    .ytp-time-current, " +
            "    .ytp-time-separator, " +
            "    .ytp-time-duration, " +
            ...
            "    }" +
            "    " +
            "    /* ✅ CRITICAL FIX: Show settings and CC buttons */" +
            "    .ytp-button, " +
            "    .ytp-settings-button, " +
            ...
            "    }" +
            "  ';" +
            "  if (!document.getElementById('ytpro-enhanced-styles')) {" +
        ...
        // ✅ FIXED: Enhanced video player features with continuous position fixing
        web.evaluateJavascript(
            "(function() {" +
            "  " +
            "  /* ✅ Fix video positioning continuously */" +
            ...
            "    var controls = document.querySelectorAll('.ytp-button, .ytp-time-display, .ytp-time-current, .ytp-time-duration');" +
            ...
            "  setInterval(fixVideoPosition, 1000);" +
            "  setInterval(enhanceVideo, 2000);" +
            "  setInterval(showControls, 1500);" +
            "  setInterval(fixVideoAspectRatio, 1000);" +
            "  " +
            "  // Initial fixes" +
            "  fixVideoPosition();" +
            "  enhanceVideo();" +
            ...
            "  fixVideoAspectRatio();" +
            "  " +
            "  console.log('✅ Video enhancements active with continuous fixes!');" +
            "  " +
            "})();",
            null
        );
  ...
  private void injectYTProScriptsFromAssets() {
    try {
        ...
        String scriptLoader = 
            ...
            "  " + loadScriptFromAssets("videoenhancements.js") + " " + // ✅ මෙන්න මේකයි add කරන්න ඕනේ!
