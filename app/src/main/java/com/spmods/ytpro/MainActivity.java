...
public class MainActivity extends Activity {
 ...
 ✅ Enhanced video player features with position fix
web.evaluateJavascript(
    ...
    "    var controls = document.querySelectorAll('.ytp-button, .ytp-time-display');" +
    ...
    "  " +
    "  console.log('✅ Video enhancements active!');" +
    "  " +
    "})();",
    null
);
