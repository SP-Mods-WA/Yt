...
public class MainActivity extends Activity {
  ...
  public class WebAppInterface {
    ...
    // 🔥🔥🔥 NEW JNI METHODS - ENCRYPTION 🔥🔥🔥
    
    @JavascriptInterface
    public String encrypt(String data) {
      if (!NativeSec.loaded()) {
        Log.e("Security", "❌ Native library not loaded");
        return "";
      }
      try {
        return NativeSec.enc(data);
      } catch (Exception e) {
        Log.e("Security", "❌ Encrypt error: " + e.getMessage());
        return "";
      }
    }
    ...
    public String decrypt(String data) {
      ...
      try {
        return NativeSec.dec(data);
      } catch (Exception e) {
        Log.e("Security", "❌ Decrypt error: " + e.getMessage());
        return "";
      }
    }
