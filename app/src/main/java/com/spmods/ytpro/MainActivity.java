    ...
    public void load(boolean dl) {
        ...
        web.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView p1, String url) {
                ...
                // ✅ Inject TV and Create buttons into YouTube's toolbar
                injectYoutubeToolbarButtons();
        ...
        web.postDelayed(new Runnable() {
            ...
            public void run() {
                String injectCode = 
                    ...
                    "        tvButton.style.cssText = 'background:none; border:none; padding:8px; margin:0 4px; cursor:pointer; display:flex; align-items:center; justify-content:center;';" +
                    "        tvButton.title = 'TV';" +
                    "        tvButton.onclick = function(e) {" +
                    "            e.preventDefault();" +
                    "            e.stopPropagation();" +
                    ...
                    "        createButton.style.cssText = 'background:none; border:none; padding:8px; margin:0 4px 0 8px; cursor:pointer; display:flex; align-items:center; justify-content:center;';" +
                    ...
                    "                var endButtons = document.querySelector('#end');" +
                    "                if (endButtons && !document.querySelector('#ytpro-tv-btn')) {" +
                    "                    addButtons();" +
                    "                    break;" +
                    "                }" +
                    "            }" +
                ...
                web.evaluateJavascript(injectCode, new ValueCallback<String>() {
                    @Override
                    public void onReceiveValue(String value) {
                        Log.d("YTPRO", "📺 TV & Create buttons injection attempted");
                    }
                });
            }
        }, 2000);
        ...
        public void showTvDialog() {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    builder.setTitle("📺 Connect to TV")
                           .setMessage("Connect your device to a TV:")
                           .setPositiveButton("Scan for devices", new DialogInterface.OnClickListener() {
                               @Override
                    ...
                    builder.setTitle("Create")
                           .setItems(options, new DialogInterface.OnClickListener() {
                               ...
                               public void onClick(DialogInterface dialog, int which) {
                                   switch (which) {
                                       case 0:
                                           Toast.makeText(MainActivity.this, "Upload video selected", Toast.LENGTH_SHORT).show();
                                           break;
                                       case 1:
                                           Toast.makeText(MainActivity.this, "Create post selected", Toast.LENGTH_SHORT).show();
                                           break;
                                       case 2:
                                           Toast.makeText(MainActivity.this, "Create short selected", Toast.LENGTH_SHORT).show();
                                           break;
                                       case 3:
                                           Toast.makeText(MainActivity.this, "Create playlist selected", Toast.LENGTH_SHORT).show();
                                           break;
                                   }
                               }
                           })
    ...
    private void showTvCodeDialog() {
        ...
        builder.setPositiveButton("Connect", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (code.length() == 6) {
                    Toast.makeText(MainActivity.this, "Connecting with code: " + code, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, "Please enter a valid 6-digit code", Toast.LENGTH_SHORT).show();
                }
            }
        });
